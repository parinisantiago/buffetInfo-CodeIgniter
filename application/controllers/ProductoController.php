...
class ProductoController extends Controller
{
    ...
    public function productosAM()
    {
        if($this->permissions())
        {
            if (isset($_POST["idProducto"])) $this->addData('producto', $this->ProductosModel->searchIdProducto($_POST["idProducto"]));
    ...
    public function productosAMPost()
    {
        if($this->permissions()){
            try
            {
                ...
                if (isset($_POST['idProducto'])) $this->addData('producto',$this ->ProductosModel->actualizarProducto($_POST));
                else $this->addData('producto',$this ->ProductosModel->insertarProducto($_POST));
    ...
    public function validarProductos($var)
    {
        ...
        if (! $this->CategoriaModel->getCategoriaById($var['idCategoria'])) throw new Exception("Error:No existe la categoria");
    }
